...
Contains hourly weather observations for Chicago Midway Airport, aligned to the time span of the Divvy bike data (2013–2025). Each row represents one hour of weather data and includes variables such as temperature, wind speed, precipitation, and weather condition codes.
