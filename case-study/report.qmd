...
##### Observations
    ...
    **Commuter Indicators**: Non-tourist station usage on weekdays shows strong morning (7–9 AM) and evening (16–18 PM) peaks, suggesting routine commuting behavior even among casual riders.
...
##### Interpretations
    ...
    **Rain as a Deterrent**: Wet conditions override other factors — both Subscribers and Customers dramatically reduce usage, regardless of temperature. This uniform suppression highlights precipitation as a powerful behavioral constraint.
...
##### Observations
    ...
    **Distance Distribution**:
        ...
        Most rides are under 2 km, with pronounced peaks around 0.85 km and 1.35 km — likely common station-to-station pairs.
...
##### Interpretations
    ...
    **Behavioral Divergence by User Type**:
        ...
        Subscribers show behavior consistent with commuting or short errands — efficient, time-sensitive trips likely shaped by pricing incentives (e.g., overage fees after 30 minutes).
...
Docked bikes, in contrast, register very low overall usage and appear to be used exclusively by Customers. This could reflect limited availability or a transitional state in fleet management. The presence of docked bikes among Customers—but not Subscribers—may point to situational or novelty-based usage.
...
However, a notable cluster of low-use outliers—approximately 130 bikes with fewer than 100 rides—may indicate anomalies. These bikes could be damaged, stolen, seasonally deployed, or simply introduced late in the analysis period.
