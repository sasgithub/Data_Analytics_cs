...
<figure class="float-right" id="fig10">
  <a href="viz/visualizations.qmd#10" target="_blank" title="Select image to see in the Visualizations Compendium">
...
<figure class="float-right" id="fig37">
  <a href="../images/.png" target="_blank" title="Select image to see in the Visualizations Compendium">
...
<figure class="float-right" id="fig21">
  <a href="viz/visualizations#fig21" target="_blank" title="Select image to see in the Visualizations Compendium">
...
- **Normalized Average Hourly Rides vs Temperature**
  ...
  - [Full-size image »](images/Avg_Hourly_Rides_vs_Temp.png){target="_blank"}


<div style="clear: right;"></div> 

<figure class="float-right" id="fig14">
  <a href="../images/Hourly_Rides_vs_Temp.svg" target="_blank" title="Select image to see in the Visualizations Compendium">
...
- **Hourly Rides vs. Temperature (2°C bins)**
  ...
  - [Full-size image »](images/Hourly_Rides_vs_Temp.png){target="_blank"}
...
<figure class="float-right" id="fig35">
  <a href="viz/visualization.qmd#fig35" target="_blank" title="Select image to see in the Visualizations Compendium">
...
<figure class="float-right" id="fig3">
  <a href="viz/visualization.qmd#fig3" target="_blank" title="Select image to see in the Visualizations Compendium">
  ...
  <figcaption>
  Figure 3: Comparison of Customer vs. Subscriber Rides by Path. This  
  </figcaption>
</figure>
