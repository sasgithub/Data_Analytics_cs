...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    if (document.referrer.includes("report.html")) {
      const backLink = document.getElementById("backlink-asymmetry");
