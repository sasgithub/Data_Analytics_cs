...
<figure class="float-right" id="fig1">
  ...
  <figcaption>
  Interactive map showing the 50 most active Divvy stations for subscribers and customers, between 2020 and 2025. Marker size indicates total ride count.
  </figcaption>
</figure>
...
The author created a tutorial using this as an example.  More details are available on [Kaggle](https://www.kaggle.com/code/yaid2r/top-stations-leaflet-demo/)
